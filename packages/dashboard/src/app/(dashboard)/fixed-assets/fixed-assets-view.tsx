...
// ---------------------------------------------------------------------------
// Fixed Assets — list/summary view and orchestration container.
//
// Sub-components:
//   _shared.tsx          — constants, helpers, StatCard/StatusBadge, types
//   add-asset-modal.tsx  — fixed asset creation modal
// ---------------------------------------------------------------------------
...
import { StatCard, StatusBadge, formatAssetTypeLabel } from './_shared';
